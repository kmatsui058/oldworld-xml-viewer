    ...
    const data: XmlLawClass.RootObject = {
  "Root": {
    "Entry": [
      {
        "zType": {
      ...
      {
        "zType": "LAWCLASS_CENTRALIZATION_VASSALAGE",
        "TechPrereq": "TECH_ARISTOCRACY"
      },
      {
        "zType": "LAWCLASS_TYRANNY_CONSTITUTION",
      ...
      {
        "zType": "LAWCLASS_MONOTHEISM_POLYTHEISM",
