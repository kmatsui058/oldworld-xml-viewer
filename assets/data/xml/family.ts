    ...
    const data: XmlFamily.RootObject = {
  "Root": {
    "Entry": [
      {
        "zType": {
      ...
      {
        "zType": "FAMILY_SARGONID",
        "Name": "TEXT_FAMILY_SARGONID",
