    ...
    const data: XmlMemoryFamily.RootObject = {
  "Root": {
    "Entry": [
      {
        "zType": {
      ...
      {
        "zType": "MEMORYFAMILY_LEAVE_COUNCIL",
        "zText": "Forced off Coucil",
        "iValue": "-100",
        "iTurns": "20"
      },
      {
      ...
      {
        "zType": "MEMORYFAMILY_DIVORCE_FORCED",
        "zText": "Forced our family member to divorce",
        "iValue": "-20",
        "iTurns": "20"
      },
      {
      ...
      {
        "zType": "MEMORYFAMILY_REFUSED_THEOLOGY",
        "zText": "Refused to establish a Theology",
        "iValue": "-20",
        "iTurns": "20"
      },
      {
      ...
      },
      {
        ...
        "zText": "Adopted our child as Heir",
        "iValue": "40",
        "iTurns": "20"
      },
      {
        "zType": "MEMORYFAMILY_ADOPT_HEIR_NO",
        "zText": "Did not adopt our child as Heir",
        "iValue": "-20",
        "iTurns": "20"
      },
      {
      ...
      {
        "zType": "MEMORYFAMILY_LAW_NO_TO_TYRANNY",
        "zText": "Refused to adopt Tyranny",
        "iValue": "-20",
        "iTurns": "10"
      },
      {
      ...
      {
        "zType": "A_MESSAGE_ARRIVES_FROM_{CHARACTER-SHORT-0}._<MASCULINE_CHARACTER-0>HE<FEMININE>SHE<END>_INVITES_YOU_TO_A_PRVIATE_GATHERING_AT_THE_{PLAYER-0,1}_PALACE,_WHERE_YOU_WILL_BE_HONORED_WITH_WINE,_SONG,_AND_LIVELY_PERFORMANCE.\n\nMEMBERS_OF_THE_COURT_ADVISE_CAUTION,_KNOWING_THAT_ACCEPTING_SUCH_AN_INVITATION_MAY_INCUR_THE_WRATH_OF_OUR_LOYAL_NOBLE_FAMILIES."
      },
      {
        "zType": "A_MESSAGE_ARRIVES_FROM_{CHARACTER-SHORT-0}._<MASCULINE_CHARACTER-0>HIS<FEMININE>HER<END>_SISTER,_WHO_HAS_BEEN_TRAVELING_WITH_A_ROYAL_RETINUE,_WILL_BE_PASSING_BY_{CITY-2}_IN_THE_COMING_MONTHS._WOULD_WE_CONSIDER_HOSTING_HER_AT_THE_LOCAL_PALACE_AND_EXHIBITING_SOME_TRADITIONAL_{PLAYER-1,1}_HOSPITALITY?\n\nIT_WOULD_BE_A_NICE_GESTURE,_BUT_WE_SHOULD_BE_CAREFUL._{CITY-2}_HAS_A_NOTORIOUSLY_OUTSPOKEN_POPULATION._DISPLAYS_OF_FOREIGN_WEALTH_MAY_CHASTEN."
      },
      {
        "zType": "AN_ENVOY_ENTERS_THE_CAPITAL,_BEARING_A_MESSAGE_FROM_{CHARACTER-SHORT-0}._THE_<MASCULINE_CHARACTER-0>KING<FEMININE>QUEEN<END>_EXPRESSES_<MASCULINE_CHARACTER-0>HIS<FEMININE>HER<END>_FRUSTRATION_WITH_OUR_RECENT_LAWS._\"YOUR_CHOICE_TO_INSTITUTE_SLAVERY_IS_A_HARBINGER_OF_{PLAYER-1}'S_DECAY.\"\n\n{CHARACTER-SHORT-0}_URGES_YOU_TO_RECONSIDER_YOUR_POLICIES."
      },
      {
