  ...
  "Root": {
    "Entry": [
      ...
      {
        "zType": "TEXT_HELPTEXT_ENTRY_COLON_TWO",
        "English": "{0}:{1}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_ENTRY_COLON_PREFIX",
        "English": ":{0}"
      },
      {
        "zType": "TEXT_HELPTEXT_ENTRY_COLON_SPACE_PREFIX",
        "English": ": {0}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_SPACE_SLASH_THREE",
        "English": "{0} {1}/{2}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0}: {1}<true_2> ({2}x)<false><end>"
      },
      {
        "zType": "TEXT_HELPTEXT_CONCAT_COLON_X_COUNT",
        "English": "{0}: {1}<true_2> x{2}<false><end>"
      },
      {
      ...
      },
      {
        ...
        "English": "<true_0> (x{0_number})<false><end>"
      },
      {
        "zType": "TEXT_HELPTEXT_INDENTED_BULLET_LIST_BUILDER_FIRST",
        "English": "icon(bullet){0}"
      },
      {
        "zType": "TEXT_HELPTEXT_INDENTED_BULLET_LIST_BUILDER",
        "English": "{0}<br>   icon(bullet){1}"
      },
      {
      ...
      },
      {
        ...
        "English": "<lt>link=\"{1_data}\"<gt>{0_value}</link>"
      },
      {
        "zType": "TEXT_HELPTEXT_COLOR",
        "English": "<lt>color={1_hexcode}<gt>{0_value}</color>"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_ERA_YEAR",
        "English": "{0_year} <true_1>CE<false>BCE<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_LEADER_REIGN",
        "English": "[{0_startYear} - {1_endYear}]"
      },
      {
        "zType": "TEXT_HELPTEXT_SIZE",
        "English": "<lt>size={0_size}%<gt>{1_value}</size>"
      },
      {
        "zType": "TEXT_HELPTEXT_SIZE_AND_COLOR",
        "English": "<lt>size={0_size}%<gt><lt>color={1_hexcode}<gt>{2_value}</color></size>"
      },
      {
        "zType": "TEXT_HELPTEXT_INLINE_ICON",
        "English": "<lt>sprite=\"{0_sheetName}\" name=\"{1_spriteName}\"/<gt>"
      },
      {
        "zType": "TEXT_HELPTEXT_INLINE_ICON_TINT",
        "English": "<lt>sprite=\"{0_sheetName}\" name=\"{1_spriteName}\" tint<gt>"
      },
      {
        "zType": "TEXT_HELPTEXT_DEFAULT_INLINE_ICON",
        "English": "<lt>sprite name=\"{1_spriteName}\"/<gt>"
      },
      {
        "zType": "TEXT_HELPTEXT_DEFAULT_INLINE_ICON_TINT",
        "English": "<lt>sprite name=\"{1_spriteName}\" tint<gt>"
      },
      {
        "zType": "TEXT_HELPTEXT_PERCENT",
        "English": "<true_0><lt>1%<false>{1}%<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_BRACKET_SELECT",
        "English": "<true_0><gt>{1}<lt><false>{1}<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_TITLE",
        "English": "<style=H1>{0}</style>"
      },
      {
        "zType": "TEXT_HELPTEXT_SUBTITLE",
        "English": "<style=H2>{LIST}</style>"
      },
      {
        "zType": "TEXT_HELPTEXT_PARAGRAPH",
        "English": "<style=P>{0}</style>"
      },
      {
      ...
      },
      {
        ...
        "English": "<true_0>+<false><end>{1_value}<true_2>%<false><end>"
      },
      {
        "zType": "TEXT_HELPTEXT_SENTENCE_CASE",
        "English": "<sentencecase>{0}</sentencecase>"
      },
      {
      ...
      },
      {
        ...
        "English": "<true_1><gt>{0}<lt><false>{0}<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_LUXURY",
        "English": "Luxury~a Luxury~Luxuries"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_DIFFICULTY",
        "English": "Difficulty ({0_difficultyLevel})"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_source} link(CONCEPT_RELIGION) ({1_religion})"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_EFFECT_CITY_SOURCE_GOVERNOR",
        "English": "{0_source} link(CONCEPT_GOVERNOR)"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_EFFECT_CITY_SOURCE_FAMILY",
        "English": "City with {0_source} link(CONCEPT_FAMILY)"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_EFFECT_CITY_SOURCE_RELIGION",
        "English": "City with {0_source} link(CONCEPT_RELIGION)"
      },
      {
      ...
      },
      {
        ...
        "English": "Most Specialists"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_LARGEST_MILITARY",
        "English": "Largest Military"
      },
      {
      ...
      },
      {
        ...
        "English": "icon(YIELD_LEGITIMACY){true_0::link(CONCEPT_LEGITIMACY)}"
      },
      {
      ...
      },
      {
        ...
        "English": "Culture Level~a Culture Level~Culture Levels"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_project}<size=70%><true_1> (Repeat)<false><end></size>"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_BUILD_QUEUE_PROJECT_COMPLETE",
        "English": "{0_projectQueue} Completed"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_DISCONTENT",
        "English": "Level {0_discontentLevel}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_AMBITIONS_MAX",
        "English": "{0}/int(MAX_AMBITIONS)"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_LEGACIES_FINISHED",
        "English": "<singular_0>Legacy<plural>Legacies<end> Finished"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_AMBITIONS_FINISHED",
        "English": "<singular_0>Ambition<plural>Ambitions<end> Finished"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_AMBITIONS",
        "English": "link(CONCEPT_AMBITION,2)"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_LINK_TRIBE_UNITS",
        "English": "Special Units"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_CHARACTER_TENDENCIES",
        "English": "Character Tendencies"
      },
      {
      ...
      },
      {
        ...
        "English": "Specialist(s)"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_CONNECTED_FOREIGN",
        "English": "Connected Foreign Cit(ies)"
      },
      {
      ...
      },
      {
        ...
        "English": "Other Cities"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_QUESTS_FINISHED",
        "English": "{singular_0:Quest:Quests} Finished"
      },
      {
      ...
      },
      {
        ...
        "English": "Starts link: {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_COOLDOWN",
        "English": "<true_0>Cooldown: <false><end>{1_turns}"
      },
      {
        "zType": "TEXT_HELPTEXT_COOLDOWN_NAME",
        "English": "Cooldown: {0_name} ({1_turns})"
      },
      {
        "zType": "TEXT_HELPTEXT_COOLDOWN_WARNING",
        "English": "On {0_name} Cooldown: {1_turns}"
      },
      {
        "zType": "TEXT_HELPTEXT_CAN_ACT_CONSUMES",
        "English": "Consumes {0_yield}"
      },
      {
        "zType": "TEXT_HELPTEXT_CAN_ACT_ROUT",
        "English": "Can only Attack after a link(CONCEPT_ROUT)"
      },
      {
        "zType": "TEXT_HELPTEXT_CAN_ACT_OTHER_TURN",
        "English": "[{0}] Cannot use during other Team's Turn"
      },
      {
        "zType": "TEXT_HELPTEXT_HURRY_WARNING_CANNOT_HURRY",
        "English": "Cannot link(CONCEPT_HURRY,2) {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_HURRY_WARNING_REQUIRES",
        "English": "Requires {0} {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_HURRY_WARNING_CITY_DAMAGED",
        "English": "Cannot link(CONCEPT_HURRY,2) if City is Damaged"
      },
      {
        "zType": "TEXT_HELPTEXT_HURRY_WARNING_CITY_EFFECT",
        "English": "Cannot link(CONCEPT_HURRY,2) because of {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_HURRY_WARNING_INCREASES_COST",
        "English": "Increases the future cost of this action in the city"
      },
      {
        "zType": "TEXT_HELPTEXT_AUTO_BUILD_CITY_EFFECT",
        "English": "Cannot Change Production because of {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_CONSUMED_PRODUCTION",
        "English": "This city's {0_yield} is being used to produce {1_production} and will not be added to the stockpile."
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_CONSUMED_PRODUCTION_GROWTH",
        "English": "This city's link(YIELD_GROWTH) is being used to produce {0_production} and will not contribute to new citizen growth."
      },
      {
      ...
      },
      {
        ...
        "English": "Recent Human Attacks ({0_number}){true_1: ON!}*"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_SAVE",
        "English": "Save the Game {0_presskey}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_SAVE_CLOUD",
        "English": "Save the Game on the cloud"
      },
      {
      ...
      },
      {
        ...
        "English": "Load the game stored on the cloud"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_SURRENDER",
        "English": "Surrender the current game"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_KICK",
        "English": "<TEXT_HOTKEY_SHIFT_CLICK> to kick player"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TOGGLE_MAP_OVERVIEW",
        "English": "Show Map Overview{true_0:<br>{0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TOGGLE_HELP_SCREEN",
        "English": "Show Help Screen{true_0:<br>{0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TOGGLE_VICTORY_SCREEN",
        "English": "Show Victory Screen{true_0:<br>{0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TOGGLE_RELIGION_SCREEN",
        "English": "Show Religion Screen{true_0:<br>{0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TOGGLE_INHERITANCE_SCREEN",
        "English": "Show Inheritance Screen{true_0:<br>{0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TOGGLE_CITY_LIST",
        "English": "Show City Screen{true_0:<br>{0_presskey}}"
      },
      {
      ...
      },
      {
        ...
        "English": "Choose Production in {0_city}{true_1: {1_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_STATE_IDLE_LOOK_AT",
        "English": "<TEXT_HOTKEY_RIGHT_CLICK> to look at {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_STATE_IDLE_DECISION",
        "English": "Make a decision about this event{true_0:<br>{0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_STATE_IDLE_RESEARCH",
        "English": "Choose Research:"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_STATE_IDLE_RESEARCH_OPEN_TREE",
        "English": "<TEXT_HOTKEY_RIGHT_CLICK> to open the Tech Tree"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CYCLE_IDLE_BUILD",
        "English": "Cycle link(CONCEPT_IDLE) Civilian Units{true_0: {0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CYCLE_IDLE_BUILD_KEYS",
        "English": "<TEXT_HOTKEY_RIGHT_CLICK> to Cycle in reverse<br><TEXT_HOTKEY_CTRL_CLICK> to Pass all<br><TEXT_HOTKEY_CTRL_SHIFT_CLICK> to Wake all<br>Drag to prioritize"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CYCLE_IDLE_MILITARY",
        "English": "Cycle link(CONCEPT_IDLE) Military Units{true_0: {0_presskey}}"
      },
      {
      ...
      },
      {
        ...
        "English": "Cycle link(CONCEPT_IDLE) link(UNIT_SCOUT,2) and Naval Units{true_0: {0_presskey}}"
      },
      {
      ...
      },
      {
        ...
        "English": "Cycle link(CONCEPT_IDLE) Cities{true_0: {0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CYCLE_IDLE_CITIES_KEYS",
        "English": "<TEXT_HOTKEY_RIGHT_CLICK> to Cycle in reverse<br>Drag to prioritize"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CYCLE_IDLE_DECISIONS",
        "English": "Make Next Decision{true_0: {0_presskey}}"
      },
      {
      ...
      },
      {
        ...
        "English": "Previous City {true_0: {0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CYCLE_NEXT_CITIES",
        "English": "Next City {true_0: {0_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_TIMER",
        "English": "Turn Timer:{true_0: {0_timer}}"
      },
      {
      ...
      },
      {
        ...
        "English": "({0_player} in {1_city})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_WONDERS_CAPTURED_BY",
        "English": "(Captured by {0_barbarian})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_WONDERS_IS_BUILDING",
        "English": "({0_player} is Building: {1_turns})"
      },
      {
      ...
      },
      {
        ...
        "English": "Active {singular_0:Law:Laws}:"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LAWS_AVAILABLE",
        "English": "Available Laws:"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CONVERT_ACTION",
        "English": "Click to spend {0_yield} for {1_order}{true_2:<br>{2_presskey}}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_NUM_CITIES",
        "English": "Your Cities: {0_number}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TECH_TREE",
        "English": "Show Technology Tree {true_0:[{0_presskey}}]"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_GIFT_YIELD",
        "English": "Send {0_yield} {1_yieldIcon} to {2_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_GIFT_YIELD_REVERSE",
        "English": "[Hold <TEXT_HOTKEY_CTRL> to Take Instead]"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_BUY_YIELD",
        "English": "Buy {0_amount} {1_yield} for {2_money}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_BUY_YIELD_KEY",
        "English": "Hold {0_key} to buy {1_amount} ({2_money})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_SELL_YIELD",
        "English": "Sell {0_amount} {1_yield} for {2_money}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_SELL_YIELD_KEY",
        "English": "Hold {0_key} to sell {1_amount} ({2_money})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_UNDO_TURN",
        "English": "<TEXT_HOTKEY_CTRL_CLICK> to undo entire turn"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_UNDO_TURN_PREVIOUS",
        "English": "<TEXT_HOTKEY_CTRL_CLICK> to rewind to end of previous turn"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_RESEARCH_TECH",
        "English": "Research {0_tech}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_RESEARCH_TECH_CANCEL",
        "English": "Cancel {0_tech}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_VICTORY_AMBITIONS",
        "English": "link(CONCEPT_AMBITION) Victory: {0}/{1}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_VICTORY_GOAL_FINISHED",
        "English": "{0}{true_1: (FINISHED)}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_REDRAW_TECH",
        "English": "Redraw techs from your deck (can only do once per {0_turnScale})"
      },
      {
      ...
      },
      {
        ...
        "English": "Active Religion(s):"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_STATE_RELIGION_CURRENT",
        "English": "State: {0_religion}{true_1: ({1_city})}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_STATE_RELIGION_ITEM",
        "English": "{0_religion}{true_1: ({1_city})}{true_2: (State)}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TRADE_LUXURY_SEND",
        "English": "Send {0_luxury} to {1_link}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TRADE_LUXURY_RETURN",
        "English": "Return {0_luxury} from {1_link}"
      },
      {
      ...
      },
      {
        ...
        "English": "Cannot Return for {0_turns} more {1_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TRADE_LUXURY_AVAILABLE",
        "English": "Currently Available: {0_amount}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_GIFT_CITY",
        "English": "Gift {0_city} to {1_player} [Hold <TEXT_HOTKEY_CTRL> to Confirm]"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_GIFT_CITY_BUTTON",
        "English": "Gift {0_city} to another player"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_GIFT_CITY_CANNOT_GIFT",
        "English": "Cannot Gift City for {0_number} {1_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_BUILD_PROJECT_REPEAT",
        "English": "Hold <TEXT_HOTKEY_SHIFT> to Repeat Until Cancelled"
      },
      {
      ...
      },
      {
        ...
        "English": "Building {0_specialist}:"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_BUILD_SPECIALIST_CURRENT",
        "English": "Current {0_specialist}:"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_BUILD_QUEUE_DRAG",
        "English": "Click + drag to reorder"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_BUILD_QUEUE_CANCEL",
        "English": "Click to cancel"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_COMPLETED_BUILD_CLEAR_ALL",
        "English": "Click to clear all"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_HURRY",
        "English": "Hurry {0} for {1_yield} and {2_yield}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_HURRY_POPULATION",
        "English": "Hurry {0} for {1_number} {singular_1:{2,0_citizenLink}:{2,2_citizenLink}} and {3_yield}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_PLAYER_NATION_CAPITAL_CITY",
        "English": "Capital City: {0_city}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TABPANEL_COURT_MEMBERS",
        "English": "Courtier(s):"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TABPANEL_OTHER_CHARACTERS",
        "English": "Other Character(s):"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TABPANEL_NO_CONTACTS",
        "English": "No Nations or Tribes Contacted Yet"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TABPANEL_UNIT_CYCLES",
        "English": "{0_cycleLink} ({1_number})"
      },
      {
      ...
      },
      {
        ...
        "English": "Playing Turn"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_PLAYER_NATION_SELECT",
        "English": "Click to select the {0_capital}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value}: {1_leader} {2_cognomen}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_PLAYER_LEGITIMACY_RECRUIT",
        "English": "{0_value}: Recruited link(CONCEPT_MERCENARY,2)"
      },
      {
      ...
      },
      {
        ...
        "English": "Click to show Inheritance screen"
      },
      {
      ...
      },
      {
        ...
        "English": "Candidate(s) available"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CANDIDATES_JOBS",
        "English": "Candidate(s) available (with Jobs)"
      },
      {
      ...
      },
      {
        ...
        "English": "Releases {0_general} from the {1_unit}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_GOVERNOR",
        "English": "{0_governor} manages {1_city}"
      },
      {
      ...
      },
      {
        ...
        "English": "Hold <TEXT_HOTKEY_CTRL> to Cancel"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_START_MISSION_CHARACTER_REQUIRES",
        "English": "Requires {0_character}: {1_subject}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_START_MISSION_CHARACTER_REQUIRES_NOT",
        "English": "Requires {0_character}: Not {1_subject}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_START_MISSION_IS_TARGET",
        "English": "Already Target of {0_mission} Mission"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_START_MISSION_CONFLICT_TURNS",
        "English": "({0} Turn(s) since last link(DIPLOMACY_WAR))"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_ABANDON_AMBITION",
        "English": "Abandon {true_0:link(CONCEPT_LEGACY):link(CONCEPT_AMBITION)}: {1_goal}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_DELAY_DECISION",
        "English": "Wait to choose an link(CONCEPT_AMBITION) in int(AMBITION_DELAY_TURNS) {0_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_MAKE_DECISION_CITY_FAMILY",
        "English": "Give {0_city} to the {1_family} Family"
      },
      {
      ...
      },
      {
        ...
        "English": "Inspire Our Troops: {0_yield}"
      },
      {
      ...
      },
      {
        ...
        "English": "Opens the Law Screen"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_MAKE_DECISION_EVENT_CHARACTER_TRAIT",
        "English": "{0_character} Becomes {1_trait}"
      },
      {
      ...
      },
      {
        ...
        "English": "Current HP: {0_amount}/{1_max}"
      },
      {
      ...
      },
      {
        ...
        "English": "Must be in Non-Hostile territory."
      },
      {
      ...
      },
      {
        ...
        "English": "Force March Unit (Can Move while Fatigued)"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_MARCH_CONFIRM",
        "English": "[Hold <TEXT_HOTKEY_CTRL> to Confirm]"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_MARCH_COST",
        "English": "Cost: {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_MARCH_ORDERS",
        "English": "(Each move will cost {0_orders})"
      },
      {
      ...
      },
      {
        ...
        "English": "Pillage {0_improvement}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_PILLAGE_YIELDS",
        "English": "Plunder: {LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "Pass (for one {0_turnScale})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_SLEEP",
        "English": "Sleep (until unit is moved, attacked, or healed)\n({0_value} HP each {1_turnScale})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_SLEEP_HEALED",
        "English": "Sleep (until unit is moved or attacked)"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_SENTRY",
        "English": "Sentry (wake if an Enemy appears within {0_value} Tiles)"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOCK",
        "English": "Lock this Unit (so only you can use it)."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_DISBAND",
        "English": "Disband the Unit"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_REPAIR",
        "English": "Repair {0_improvement}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FOUND_CITY_CAPITAL",
        "English": "Found the Capital"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FOUND_CITY_FAMILY_SEAT",
        "English": "Found {0_familySeat}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FOUND_CITY",
        "English": "Found a City"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_OPINION_DISTANCE",
        "English": "link(CONCEPT_OPINION_FAMILY,3): Distance from {0} to {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_OPINION_MISSING_LUXURIES",
        "English": "link(CONCEPT_OPINION_FAMILY,3): Missing link(CONCEPT_LUXURY){true_LIST-COUNT: ({LIST})} from {0} to {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_OPINION_CONNECTED_CITIES",
        "English": "link(CONCEPT_OPINION_FAMILY,3): {0_connected} Cities from {1} to {2}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_OPINION_ENVY",
        "English": "link(CONCEPT_OPINION_FAMILY,3): Envy from {0} to {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_OPINION_ENVY_FAMILY",
        "English": "link(CONCEPT_OPINION_FAMILY,3): Envy from {1} to {2} ({0_family})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_OPINION_MOST_FEWEST_CITIES",
        "English": "link(CONCEPT_OPINION_FAMILY,3): Most/Fewest Cities from {0} to {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_CITY_OPINION_MOST_FEWEST_CITIES_FAMILY",
        "English": "link(CONCEPT_OPINION_FAMILY,3): Most/Fewest Cities from {1} to {2} ({0_family})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FOUND_CITY_FOUND_COST",
        "English": "Cost {0_money}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FAMILY_FOUND_BONUS",
        "English": "Same Family: {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FAMILY_SEAT_BONUS",
        "English": "link(CONCEPT_FAMILY_SEAT): {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FAMILY_SEAT_WARNING",
        "English": "Skipped link(CONCEPT_FAMILY_SEAT): {LIST}/{0_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FOUND_CITY_MAX_FAMILIES",
        "English": "Max Families: {0_value}/{1_max}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FOUND_CITY_REMOVES_RESOURCE",
        "English": "Removes the {0_resource}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_FOUND_CITY_NOT_CONNECTED",
        "English": "New City will not be {0_connectedLink} to the {1_capitalLink}"
      },
      {
      ...
      },
      {
        ...
        "English": "Join {0_city}<br>Adds {1_number} <singular_1>{2_citizenLink}<plural>{2,2_citizenLink}<end> to the City [Hold <TEXT_HOTKEY_CTRL> to Confirm]"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_JOIN_CITY_UNIT_DAMAGED",
        "English": "Must be fully Healed"
      },
      {
      ...
      },
      {
        ...
        "English": "Invalid on {0_link}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_UPGRADE_IMPROVEMENT",
        "English": "Upgrade to {0_improvement}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_ADD_REMOVE_VEGETATION",
        "English": "Removes {0_vegetation}{true_1: ({1_list})}"
      },
      {
      ...
      },
      {
        ...
        "English": "Cannot Harvest on a Tile with an Improvement"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_HARVEST_RESOURCE_NEEDS_TIME",
        "English": "{0_resource} needs time to regenerate (Each {1_turnScale}: 1d{2_die})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_HARVEST_RESOURCE_NO_YIELD",
        "English": "Too far from a friendly City"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_HARVEST_RESOURCE_AUTO_HARVEST_HOTKEY",
        "English": "Hold <TEXT_HOTKEY_CTRL> to turn <true_0>off<false>on<end> Auto-Harvest"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_COLONIZE_TILE",
        "English": "Colonize Tile for {0_money}{true_1: in {1_city}}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_amount} XP for this Unit ({1_xp}/{2_xpMax})"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_PROMOTE_COST",
        "English": "Cost: {0_yield}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_UPGRADE",
        "English": "Upgrade to {0_unit}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_UPGRADE_COSTS",
        "English": "Costs {0_amount} {1_yieldIcon}"
      },
      {
      ...
      },
      {
        ...
        "English": "Requires City with {0} link(YIELD_CULTURE)"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_UPGRADE_REQUIRES_IMPROVEMENT",
        "English": "Requires City with {0}"
      },
      {
      ...
      },
      {
        ...
        "English": "Gift to {0_player} [Hold <TEXT_HOTKEY_CTRL> to Confirm]"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LAUNCH_OFFENSIVE",
        "English": "Reduces the Cooldown of Adjacent Units and gives {0_yield} for each one"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LAUNCH_OFFENSIVE_CONCEPT",
        "English": "Reduces the Cooldown of Adjacent Units and gives +1 icon(YIELD_ORDERS) for each"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LAUNCH_OFFENSIVE_NOT_YOUR_TURN",
        "English": "Must be your turn"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LAUNCH_OFFENSIVE_ONLY_ONE_PER_TURN",
        "English": "Can only use one Offensive per {0_turnScale}"
      },
      {
      ...
      },
      {
        ...
        "English": "Requires an established link(CONCEPT_THEOLOGY) from the previous tier"
      },
      {
        "zType": "TEXT_HELPTEXT_THEOLOGIES_AVAILABLE_TIER",
        "English": "Available theologies (use a Disciple to establish):"
      },
      {
      ...
      },
      {
        ...
        "English": "A new {0_courtier} has emerged."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_RELIGION_FOUNDED",
        "English": "The new {0_religion} appears in {1_city}."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_THEOLOGY_ESTABLISHED",
        "English": "{0_religion} has established the link(CONCEPT_THEOLOGY) of {1_theology}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_RELIGION_SPREAD",
        "English": "Some citizens of {0_city} now follow {1_religion}."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_COVER_DEBT",
        "English": "Your Debt was {0_money} at the end of the {1_turnScale}."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_MAX_ACTIONS",
        "English": "{0_action} which cannot be stored are sold for {1_training}."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_MAX_CIVICS",
        "English": "You cannot stockpile more than {0_civicsValue}."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_MAX_TRAINING",
        "English": "You cannot stockpile more than {0_trainingValue}."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_GENERAL_INJURY",
        "English": "link(CONCEPT_GENERAL,2) have a small ({0_number}%) chance of being injured when the Unit is attacked."
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_UNIT_ATTACKED",
        "English": "Attacked by {0,1_unit} from {1_tilePosition}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_UNIT_KILLED",
        "English": "Killed by {0,1_unit} from {1_tilePosition}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_UNIT_REBELLED",
        "English": "{sentencecase:{0,1_unit}}{true_1: (from the {1_family} Family)} has Rebelled {2_tilePosition}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_UNIT_SEEN",
        "English": "Hostile {0,1_unit} seen at {1_tilePosition}"
      },
      {
      ...
      },
      {
        ...
        "English": "Finished {0,1_improvement}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_LOG_MESSAGE_IMPROVEMENT_PILLAGED",
        "English": "Pillaged by {0,1_unit}"
      },
      {
      ...
      },
      {
        ...
        "English": "Sent from {0_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_REPLAY_WHOLE_GAME",
        "English": "Replay the entire game{true_0: in 1-Turn steps}"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_REPLAY_CLEAR_DATA",
        "English": "Clear the replay data"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_REPLAY_LAST_TURN",
        "English": "Replay the actions over the last Turn"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_REPLAY_LAST_X_TURNS",
        "English": "Replay the actions over the last {0_number} Turns"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_TURN_REPLAY_CANCEL",
        "English": "Cancel the replay and return to live action"
      },
      {
      ...
      },
      {
        ...
        "English": "Use AI to finish turn<br><TEXT_HOTKEY_CTRL_CLICK> to auto-play {0_number} <singular_0>turn<plural>turns<end>"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_WIDGET_POPULATION",
        "English": "City Population"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_INHERITANCE_TREE_LEADER_FUTURE_LEADER",
        "English": "Future Leader"
      },
      {
      ...
      },
      {
        ...
        "English": "link(CONCEPT_RELIGION,2) provide link(YIELD_CULTURE,1) and affect link(YIELD_DISCONTENT,1) in Cities with them. (For example, a City with a link(OPINIONRELIGION_FRIENDLY) link(CONCEPT_RELIGION) will have its link(YIELD_DISCONTENT) reduced by 2.)\n\t\t\nYou can choose to adopt a link(CONCEPT_STATE_RELIGION) for your link(CONCEPT_NATION), allowing you to guide the impact that link(CONCEPT_RELIGION) has on your Cities via link(CONCEPT_THEOLOGY,2)."
      },
      {
      ...
      },
      {
        ...
        "English": "Once you have a link(COUNCIL_SPYMASTER), link(UNIT_SCOUT,1) can create an Agent Network in a Foreign City to gain visibility. (The link(UNIT_SCOUT) will be automatically returned after int(AGENT_NETWORK_TURNS) Turns.) A Character can then be sent to the City to serve as an link(CONCEPT_AGENT)."
      },
      {
      ...
      },
      {
        ...
        "English": "{0_player} will capture {1_city} in {2_turns} more {3_turnScale}.\n(Must keep a Military Unit in the City.)"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_yield}: King/Queen is link(CONCEPT_GOVERNOR)"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_FOREIGN_POPULATION",
        "English": "{0_yield}: Foreign Population ({1_nation})"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_DEFENDING",
        "English": "{0_yield}: Defending {true_1:Family }Unit"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_MISSING_FAMILY",
        "English": "{0_yield}: Not Enough link(CONCEPT_FAMILY_SEAT,2)"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_URBAN_TILE",
        "English": "{0_yield}: Need more {1_urbanLink} Tiles for {2,2_citizens}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_EMPTY_IMPROVEMENT",
        "English": "{0_yield}: Improvements w/o Specialists"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_CAPITAL_DISTANCE",
        "English": "{0_yield}: Distance from {1_capitalCity}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_GOVERNOR_OPINION",
        "English": "{0_yield}: {1_opinion} link(CONCEPT_GOVERNOR) ({2_governor})"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_DISCONTENT",
        "English": "{0_yield}: link(YIELD_DISCONTENT) {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_DAMAGE_YIELD_MODIFIER",
        "English": "{0_yield}: from Damage ({1_hp}/{2_maxHP})"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_ASSIMILATE_YIELD_MODIFIER",
        "English": "{0_yield}: from Assimilation"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_CITY_GOVERNOR_YIELD_MODIFIER",
        "English": "{0_yield}: link(CONCEPT_GOVERNOR) {1} ({2})"
      },
      {
      ...
      },
      {
        ...
        "English": "Foreign Cities connected to your {0_capital} (Requires link(DIPLOMACY_PEACE)):\n(Larger and more distant cities produce more)"
      },
      {
      ...
      },
      {
        ...
        "English": "link(YIELD_CULTURE) Levels:"
      },
      {
      ...
      },
      {
        ...
        "English": "Defense Strength"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_DISCONTENT_LEVEL",
        "English": "link(YIELD_DISCONTENT) Level: {0}"
      },
      {
      ...
      },
      {
        ...
        "English": "Defended by {0_family} Military Unit ({LIST}/{1_turnScale})"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_DISCONTENT_DEFENDING",
        "English": "Defended by Military Unit ({LIST}/{0_turnScale})"
      },
      {
        "zType": "TEXT_HELPTEXT_HIDDEN_WITHOUT_AGENT",
        "English": "Details Hidden without an link(CONCEPT_AGENT)"
      },
      {
      ...
      },
      {
        ...
        "English": "You can attack each other freely."
      },
      {
      ...
      },
      {
        ...
        "English": "Total link(CONCEPT_SPECIALIST,2)"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_FAMILY_SPECIALISTS_ALL_DESC",
        "English": "Based on total link(CONCEPT_SPECIALIST,2) for Family's Cities"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_FAMILY_SEAT_EFFECTS",
        "English": "{0_family} link(CONCEPT_FAMILY_SEAT):"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_FAMILY_UNITS",
        "English": "{0_family} Units:"
      },
      {
      ...
      },
      {
        ...
        "English": "This {0_resource} has been Harvested and cannot be Harvested again until it randomly recharges."
      },
      {
      ...
      },
      {
        ...
        "English": "{0} Unit {RANGE}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_HEIGHT_BUILD",
        "English": "{0} Build {1_turnScale}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value}: {1_turns} {2_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_MEMORY_INFINITE",
        "English": "{0_value}: Infinite"
      },
      {
      ...
      },
      {
        ...
        "English": "Units forced to Retreat will move to a valid adjacent Tile. If none exists, then the Unit is link(CONCEPT_STUN,2)."
      },
      {
      ...
      },
      {
        ...
        "English": "{RELIGION-ADJECTIVE,1} link(CONCEPT_IMPROVEMENT,2) in {1_city}:"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_RELIGION_CITIES_US",
        "English": "Our {0_religion} Cities:<br>{LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_RELIGION_CITIES_THEM",
        "English": "Other {0_religion} Cities:<br>{LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_RIVER_BLOCKS_ZOC",
        "English": "Blocks {0_ZOCLink}"
      },
      {
      ...
      },
      {
        ...
        "English": "All descendants of your dynasty's founder are Royals, which makes them eligible for the link(CONCEPT_SUCCESSION) and to be link(CONCEPT_TUTOR,3). Each Royal will cost some link(YIELD_MONEY,1) per Turn."
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_SELECT_TRIBE",
        "English": "Click to Select Tribe"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_SELECT_CHARACTER",
        "English": "Click to Select Character"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_SELECT_CITY",
        "English": "Click to Select City"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_SELECT_FAMILY",
        "English": "Click to Select Family"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_SELECT_UNIT",
        "English": "Click to Select Unit"
      },
      {
      ...
      },
      {
        ...
        "English": "A Stunned Unit cannot move, attack, or take any other type of action."
      },
      {
      ...
      },
      {
        ...
        "English": "Trade from: {0_yield} {1_turns}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_TRADE_BONUS_THEM",
        "English": "Trade to: {0_yield} {1_turns}"
      },
      {
      ...
      },
      {
        ...
        "English": "Can have only link(CONCEPT_URBAN) Improvements."
      },
      {
      ...
      },
      {
        ...
        "English": "{0} Vegetation"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_VEGETATION_DEFEND",
        "English": "Vs. {0_unitTrait}: {1_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_VEGETATION_HOTKEY",
        "English": "Hold [{0_key}] to hide all {1_vegetation} art."
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_VICTORY",
        "English": "If any of your opponents reach {0_points} points, the game ends"
      },
      {
      ...
      },
      {
        ...
        "English": "{0}: from {1} {2_culture} {singular_1:City:Cities}"
      },
      {
        "zType": "TEXT_HELPTEXT_LINK_HELP_VICTORY_FROM_LEGENDARY_CITY",
        "English": "{0}: from {1_city} ({2_culture})"
      },
      {
      ...
      },
      {
        ...
        "English": "(Requires {0_tech})"
      },
      {
        "zType": "TEXT_HELPTEXT_TILE_TOOLTIP_RECENTLY_SEEN",
        "English": "Recently Seen:"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_RATE",
        "English": "{0_yield} Rate: {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_RESEARCHING",
        "English": "Researching: {0_tech} {1_progress}"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_CITY_SUBTRACT_LIST_ITEM",
        "English": "({0_yield})"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_TRADE_TO_PLAYER",
        "English": "{0}: Trade to {1_player} {2_turns}"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_TRADE_FROM_PLAYER",
        "English": "{0}: Trade from {1_player} {2_turns}"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_TRIBUTE_TRIBES",
        "English": "{0}: Tribute {true_1:from:to} {2_barbarian} {3_turns}"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_TRIBUTE_TO_PLAYER",
        "English": "{0}: Tribute to {1_player} {2_turns}"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_TRIBUTE_FROM_PLAYER",
        "English": "{0}: Tribute from {1_player} {2_turns}"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_UNIT_CONSUMPTION",
        "English": "{0}: {1consumptionLink}{true_2: ({2}x)}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0}: link(CONCEPT_ROYAL,2)"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_COURTIERS",
        "English": "{0}: link(CONCEPT_COURTIER,2)"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_CONSTRUCTION",
        "English": "{0}: Improvement Construction"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_CITY_SITE",
        "English": "{0}: Guarding link(IMPROVEMENT_CITY_SITE)(s)"
      },
      {
        "zType": "TEXT_HELPTEXT_YIELD_NET_CARAVAN_MISSIONS",
        "English": "{0}: Active link(CONCEPT_CARAVAN_MISSION)(s)"
      },
      {
      ...
      },
      {
        ...
        "English": "Effects of being the Capital:"
      },
      {
      ...
      },
      {
        ...
        "English": "Cannot build on a Harvested Tile"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_REQUIRES_TECH",
        "English": "Requires Tech: {0_techLink}"
      },
      {
      ...
      },
      {
        ...
        "English": "Adjacent {0_height}"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_REQUIRES_TEAM",
        "English": "Cannot be built outside own territory"
      },
      {
      ...
      },
      {
        ...
        "English": "Unlocks {0_unit} Unit:"
      },
      {
        "zType": "TEXT_HELPTEXT_TECH_UNLOCKS_IMPROVEMENT_CLASS",
        "English": "Unlocks {0_improvemntClass} Improvement(s):"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_tech}{true_LIST-COUNT: (with {LIST})}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_TECH_BONUS_CARDS",
        "English": "Bonus {singular_LIST-COUNT:Card:Cards}: {LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} of {1_yield} in {2_city}{true_3: from {3_effect}}"
      },
      {
      ...
      },
      {
        ...
        "English": "Reveal Range: {0_amount}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_FATIGUE_LIMIT",
        "English": "Fatigue Limit: {0_amount}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_ATTACKS",
        "English": "Attacks {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_ATTACK_VALUE_ITEM",
        "English": "{0_attackType}{true_1: ({1})} at {2}%"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_VS",
        "English": "Vs. {0_unitTrait}:"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_STRENGTH_MELEE_VS",
        "English": "link(UNITTRAIT_MELEE) vs. {0_unitTrait}:"
      },
      {
      ...
      },
      {
        ...
        "English": "Spreads {0_religion}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_AMPHIBIOUS",
        "English": "Can Move on Land or Water"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_CAN_CARAVAN_MISSION",
        "English": "Can Conduct a link(CONCEPT_CARAVAN_MISSION)"
      },
      {
      ...
      },
      {
        ...
        "English": "Can {0_harvestLink}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_CAN_BUILD_IMPROVEMENTS",
        "English": "Can Build Improvements"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} {singular_0:Level:Levels}"
      },
      {
      ...
      },
      {
        ...
        "English": "Starts with {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_CONSUMES",
        "English": "Consumes {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_TYPE_IMPROVEMENT_YIELD",
        "English": "On {0_improvement}: {LIST}/{1_turnScale}"
      },
      {
      ...
      },
      {
        ...
        "English": "Costs {0_value} {singular_0:{1_citizenLink}:{1,2_citizenLink}}"
      },
      {
      ...
      },
      {
        ...
        "English": "Movement: {0} icon(MOVEMENT)"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_RANGE",
        "English": "Range: {0} icon(RANGE)"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_RANGE_MIN_MAX",
        "English": "Range: {0}-{1} icon(RANGE)"
      },
      {
      ...
      },
      {
        ...
        "English": "Defense: {0} icon(DEFENSE)"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_CRITICAL",
        "English": "Critical: {0} icon(CRITICAL_STRIKE)"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_FATIGUED",
        "English": "Unit is Fatigued: 0/{0}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_FATIGUE",
        "English": "Moves until Fatigued: {0}/{1}"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_FATIGUED_HELP",
        "English": "(Fatigued Units cannot move without Force March)"
      },
      {
      ...
      },
      {
        ...
        "English": "Removes the {0_resourceLink}"
      },
      {
        "zType": "TEXT_HELPTEXT_REMOVES_VEGETATION",
        "English": "Removes the {0_vegetationLink}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} (in {1_city}, {2_value}/{3_total} {4_icon})"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_FATIGUE_LIMIT",
        "English": "<true_1>{0_value} Fatigue Limit<false>Fatigue Limit: {0_value}<end>"
      },
      {
      ...
      },
      {
        ...
        "English": "<true_2>Across {0_riverLink}: {1_value}<false>{1_value} Across {0_riverLink}<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_ATTACK_LAND_WATER",
        "English": "<true_1>Land/Water Combat: {0_value}<false>{0_value} Land/Water Combat<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_HOME_MODIFIER",
        "English": "<true_1>National Territory: {0_value}<false>{0_value} in National Territory<end>"
      },
      {
      ...
      },
      {
        ...
        "English": "<true_2>From {0_tileLink}: {1_value}<false>{1_value} From {0_tileLink}<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_IF_DAMAGED",
        "English": "<true_1>If Damaged: {0_value}<false>{0_value} If Damaged<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_VS_DAMAGED",
        "English": "<true_1>Vs. Damaged: {0_value}<false>{0_value} Vs. Damaged<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_VS_GENERAL",
        "English": "<true_1>Vs. link(CONCEPT_GENERAL): {0_value}<false>{0_value} Vs. link(CONCEPT_GENERAL)<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_FLANKING_ATTACK",
        "English": "<true_1>If link(CONCEPT_FLANKING): {0_value}<false>{0_value} If link(CONCEPT_FLANKING)<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_SAME_UNIT_ADJACENT",
        "English": "<true_1>If Same Unit Adjacent: {0_value}<false>{0_value} If Same Unit Adjacent<end>"
      },
      {
      ...
      },
      {
        ...
        "English": "Can Add Multiple Roads per Year"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_ATTACK_VALUE_ITEM",
        "English": "Attacks {0_attackType}{true_1: {1}}{true_2: at {2}%}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_VS_UNIT_TRAIT",
        "English": "<true_2>Vs. {0_unitTrait} Units: {1_value}<false>{1_value} Vs. {0_unitTrait} Units<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_IN_MELEE_VS",
        "English": "<true_2>link(UNITTRAIT_MELEE) Combat Vs. {0_unitTrait} Units: {1_value}<false>{1_value} link(UNITTRAIT_MELEE) Combat Vs. {0_unitTrait} Units<end>"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_UNIT_HELP_UNIT_MILITARY_KILL_YIELD",
        "English": "{0_yield} per Military Unit killed"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value} {1_specialist} Cost"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value} link(CONCEPT_PROJECT) Costs"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value} {1_turnScale} to Build Improvements"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_NO_YIELDS_URBAN_BUILD_TURNS",
        "English": "{0_value} {1_turnScale} to Build link(CONCEPT_URBAN) Improvements"
      },
      {
      ...
      },
      {
        ...
        "English": "Can Always Build link(CONCEPT_STATE_RELIGION) Improvements"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_NO_YIELDS_UNIT_COST_MODIFIER",
        "English": "{0_value} Cost for {1,2_unit}"
      },
      {
      ...
      },
      {
        ...
        "English": "New {1_unitTrait} Units: {0_value} XP"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_NO_YIELDS_UNIT_TRAIT_LEVEL",
        "English": "New {1_unitTrait} Units: {0_value} {singular_0:Level:Levels}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_NO_YIELDS_UNIT_TRAIT_COST_MODIFIER",
        "English": "{0_value} Cost for {1_unitTrait} Units"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value} Upgrade {1_turnScale} for {2_improvement} Improvements"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_NO_YIELDS_NO_IMPROVEMENT_CLASS_MAX",
        "English": "Can Build Unlimited {0,2_improvementClass}"
      },
      {
      ...
      },
      {
        ...
        "English": "Can link(CONCEPT_HURRY,2) {0,2_build} with link(YIELD_CIVICS)"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_HURRY_TRAINING",
        "English": "Can link(CONCEPT_HURRY,2) {0,2_build} with link(YIELD_TRAINING)"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_HURRY_MONEY",
        "English": "Can link(CONCEPT_HURRY,2) {0,2_build} with link(YIELD_MONEY)"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_HURRY_POPULATION",
        "English": "Can link(CONCEPT_HURRY,2) {0,2_build} with Population"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_HURRY_ORDERS",
        "English": "Can link(CONCEPT_HURRY,2) {0,2_build} with link(YIELD_ORDERS)"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_NO_YIELDS_NEW_UNITS_WITH",
        "English": "New Units start with {0_link}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_NO_YIELDS_UNIT_TRAIT_FREE_PROMOTIONS",
        "English": "New {0_unitTrait} Units start with {1_promotion}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_NO_YIELDS_FREE_UNIT_EFFECT_CITY",
        "English": "Can build Units that require {LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "{LIST}/{0_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_YIELDS_IN_CITY",
        "English": "{0} in {1_city}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_yield}/{1_turnScale} per {2_effectCity}"
      },
      {
      ...
      },
      {
        ...
        "English": "{LIST,2}: {0_value} Output"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_YIELDS_IMPROVEMENT_RIVER_MODIFIER",
        "English": "{0_value} from {1_improvement} on {2_riverLink}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_YIELDS_IMPROVEMENT_CLASS_MODIFIER_YIELD",
        "English": "{0,2_improvementClassList}: {1_value} Output"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_CITY_HELP_YIELDS_IMPROVEMENT_CLASS_YIELD",
        "English": "{0,2_improvementClassList}: {1_value}"
      },
      {
      ...
      },
      {
        ...
        "English": "Produces {0,2_barbarianAdjective} Units"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_PRODUCES_GENERIC_TRIBE_UNITS",
        "English": "Produces link(TRIBE_BARBARIANS,1) Units"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value} for Adjacent {LIST,2}"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_FOR_ADJACENT_IMPROVEMENT_CLASS_MODIFIER",
        "English": "{0_value} for Adjacent {LIST} Class Improvements"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_PER_ADJACENT_IMPROVEMENT_MODIFIER",
        "English": "{0_value} per Adjacent {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_PER_ADJACENT_IMPROVEMENT_CLASS_MODIFIER",
        "English": "{0_value} per Adjacent {LIST} Class Improvement"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_THEOLOGY_YIELD_RATE",
        "English": "{0_theology}: {1_yieldValueList}{true_2: ({2_cityYieldValueList})}"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_HEALS_UNIT",
        "English": "Heals {0_value} HP for {1_idle} Units"
      },
      {
      ...
      },
      {
        ...
        "English": "Heals {0_value} HP for {1_idle} {LIST} Units"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_UNIT_TRAIT_XP",
        "English": "{0_value} XP/{1_turnScale} for {2_idle} {LIST} Units"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_ENABLES",
        "English": "Enables {LINK}"
      },
      {
      ...
      },
      {
        ...
        "English": "Source of {0_link}"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_YIELDS_PER_YEAR",
        "English": "{YIELD-LIST}/{0_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_YIELDS_ADJACENT_IMPROVEMENTCLASS",
        "English": "{LIST}/{0_turnScale} per Adjacent {1_improvementClass}"
      },
      {
      ...
      },
      {
        ...
        "English": "{LIST}/{0_turnScale} per Adjacent Resource"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_YIELDS_TRADE_NETWORK",
        "English": "{LIST} if on link(CONCEPT_TRADE_NETWORK)"
      },
      {
      ...
      },
      {
        ...
        "English": "Potential Bonuses:"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_DEFENSE_MODIFIER",
        "English": "{0_value} {true_1:icon(DEFENSE) for Friendly Units:Tile icon(DEFENSE)}"
      },
      {
      ...
      },
      {
        ...
        "English": "Can link(CONCEPT_HEAL) Units Anywhere"
      },
      {
      ...
      },
      {
        ...
        "English": "Develops into {0_improvement} in {1_number} {2_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_DEVELOP_TURNS_RANDOM",
        "English": "Develops into {0_improvement} in {1_number} - {2_number} Turns"
      },
      {
        "zType": "TEXT_HELPTEXT_IMPROVEMENT_HELP_BUILT_BY_RELIGIOUS_UNITS",
        "English": "Built by Religious Units"
      },
      {
      ...
      },
      {
        ...
        "English": "A City is connected to its {0_capital}"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_CONNECTED_EFFECTS",
        "English": "Effects of being Connected:"
      },
      {
      ...
      },
      {
        ...
        "English": "Citizens can be used to create new Specialists"
      },
      {
        "zType": "TEXT_HELPTEXT_CITIZENS_URBAN_NEEDED",
        "English": "Citizens need {0} more link(CONCEPT_URBAN) {singular_0:Tile:Tiles} ({LIST}/{1_turnScale})"
      },
      {
        "zType": "TEXT_HELPTEXT_CITIZENS_COUNT",
        "English": "Citizens: {0}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value} Start Law Cost"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_SWITCH_LAW_MODIFIER",
        "English": "{0_value} Switch Law Cost"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_TRAINING_MODIFIER",
        "English": "{0_value} Cost to Spend {1_trainingIcon} for {2_yield}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_FATIGUE_LIMIT_CHANGE",
        "English": "{0_value} Fatigue Limit"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value} Tech Card Hand Size"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_LEADER_OPINION_CHANGE",
        "English": "All Foreign/Tribal Leader Opinions {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HEAD_OPINION_CHANGE",
        "English": "All Tribal Leader and link(CONCEPT_RELIGION)/link(CONCEPT_FAMILY) Head Opinions {0_value}"
      },
      {
      ...
      },
      {
        ...
        "English": "Multiple link(UNIT_WORKER,2) can build Improvements"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_CAN_BUY_TILES",
        "English": "Can {0_buyTiles}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_CAN_AGENT",
        "English": "Can Create {0_agentNetwork} in Foreign Cities"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_RIVER_MOVEMENT_BONUS",
        "English": "Movement Bonus along Neutral {0_river}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_NO_SELL_PENALTY",
        "English": "Can Sell for the same price as Buying"
      },
      {
      ...
      },
      {
        ...
        "English": "Disciples Can Purge World Religions"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_BUILD_ALL_RELIGIONS",
        "English": "Can Build Non-link(CONCEPT_STATE_RELIGION) Disciples"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_PAGAN_STATE_RELIGION",
        "English": "Can Adopt Pagan State Religions"
      },
      {
      ...
      },
      {
        ...
        "English": "Recruit Tribal link(CONCEPT_MERCENARY,2) with {0_legitimacy}"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_HIRE_MERCENARIES",
        "English": "Can Hire link(CONCEPT_MERCENARY,2) from Tribes"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_AUTOMATE_WORKERS",
        "English": "Can Automate link(UNIT_WORKER,2)"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_UNIT_MILITARY_KILL_YIELD",
        "English": "{0_yield} per Military Unit killed"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_WAR_YIELD",
        "English": "{0_yield}/{1_turnScale} per link(DIPLOMACY_WAR)"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_yield}/{1_turnScale} per City"
      },
      {
        "zType": "TEXT_HELPTEXT_EFFECT_PLAYER_HELP_TRADE_YIELD",
        "English": "Can Buy/Sell {0_yield}"
      },
      {
      ...
      },
      {
        ...
        "English": "link(CONCEPT_HOLY_CITY,2): {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILYCLASS_OPINION_NO_RELIGION",
        "English": "City without a Religion: {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILYCLASS_OPINION_CONNECTED",
        "English": "Connected Cities: {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILYCLASS_OPINION_DAMAGED_CITIES",
        "English": "Damaged Cities: {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILYCLASS_OPINION_CITY_DEFENDED_UNITS",
        "English": "Defended Cities: {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILYCLASS_OPINION_PILLAGED_OPINION",
        "English": "Pillaged link(CONCEPT_IMPROVEMENT,2) inside Territory: {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILYCLASS_OPINION_HOSTILE_UNITS_IN_TERRITORY",
        "English": "Hostile Units inside Territory: {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILYCLASS_OPINION_LUXURIES",
        "English": "link(CONCEPT_LUXURY): {0_value}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILYCLASS_OPINION_LUXURY_MISSING",
        "English": "Missing {0_luxury}: {1_value}/City"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_tributeLink} from: {YIELD-LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_TRIBE_TRIBUTE_TO",
        "English": "{0_tributeLink} to: {YIELD-LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "Same Nation (General)"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_ATTACK_PREVIEW_GENERAL_SAME_TRIBE",
        "English": "Same Tribe (General)"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_ATTACK_PREVIEW_GENERAL_DIFF_TRIBE",
        "English": "Different Tribe (General)"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_ATTACK_PREVIEW_GENERAL_SAME_FAMILY",
        "English": "Same Family (General)"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_ATTACK_PREVIEW_UNIT_BONUS",
        "English": "{0_bonusReason} (as {1_unitAbility})"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_ATTACK_PREVIEW_UNIT_BONUS_VS",
        "English": "Vs. {0_bonusReason} (as {1_unitAbility})"
      },
      {
        "zType": "TEXT_HELPTEXT_UNIT_ATTACK_PREVIEW_UNIT_TRAIT_BONUS_MELEE_VERSUS",
        "English": "link(UNITTRAIT_MELEE) combat vs. {0_unitTrait}"
      },
      {
      ...
      },
      {
        ...
        "English": "Gift {0_yieldIcon}"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_ACTIONS_GIFT_TO",
        "English": "Gift to {0_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_SELECTION_CHOOSE_GOVERNOR",
        "English": "Choose link(CONCEPT_GOVERNOR)"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_SELECTION_GOVERNOR",
        "English": "link(CONCEPT_GOVERNOR)"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_SELECTION_FAMILY_OPINION",
        "English": "Family: {0_family}{true_1: ({1_opinion})}"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_SELECTION_CITIZENS_NO_NUM",
        "English": "{singular_0:Citizen:Citizens}"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_YIELD_PROGRESS_GROWTH",
        "English": "({0_value}/{1_value})"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_YIELD_PROGRESS_CULTURE",
        "English": "({0_culture}: {1_value}/{2_value})"
      },
      {
        "zType": "TEXT_HELPTEXT_CITY_YIELD_PROGRESS_DISCONTENT",
        "English": "(Level {0_discontent}: {1_value}/{2_value})"
      },
      {
        "zType": "TEXT_HELPTEXT_SHOW_CHOOSE_RESEARCH_POPUP_TURNS_LEFT",
        "English": "{0_turnsLeft} {1_turnScale}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_SHOW_CHOOSE_RESEARCH_POPUP_TECH_WITH_OTHER_TECHS",
        "English": "{0_tech} (with {1_techList})"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_project} ({1_link})"
      },
      {
        "zType": "TEXT_HELPTEXT_SHOW_CHOOSE_RESEARCH_POPUP_DESC_UNLOCKS_UNIT",
        "English": "{0_unit} (Unit)"
      },
      {
        "zType": "TEXT_HELPTEXT_SHOW_CHOOSE_RESEARCH_POPUP_DESC_UNLOCKS_IMPROVEMENT_CLASS",
        "English": "{0_improvementClass} Improvements"
      },
      {
        "zType": "TEXT_HELPTEXT_SHOW_CHOOSE_RESEARCH_POPUP_DESC_UNLOCKS_LAW",
        "English": "{0_law} (Law)"
      },
      {
      ...
      },
      {
        ...
        "English": "[All Nations of {0_player}]"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_MEMORY_ALL_TRIBES_START",
        "English": "[All Tribes of {0_player}]"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_MEMORY_ALL_FAMILIES_START",
        "English": "[All Families]"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_STARTS_QUEST",
        "English": "Starts Quest {0_goalLink}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_STARTS_AMBITION",
        "English": "Starts link(CONCEPT_AMBITION) {0_goalLink}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_FINISH_GOAL",
        "English": "Finish Goal {0_goalLink}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_FAIL_GOAL",
        "English": "Fail Goal {0_goalLink}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_character} joins the link(CONCEPT_NATION) of {1_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_REVEAL_TERRITORY",
        "English": "Reveal Territory of {0_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_CANCEL_TRADE",
        "English": "Cancel Trade with {0_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_SEND_LUXURY_TO",
        "English": "Send {0_luxury} to {1_familyOrPlayer} as {2_luxuryLink}"
      },
      {
      ...
      },
      {
        ...
        "English": "Gain from {0_opponent}: {1_yieldList}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_SEND_TO",
        "English": "Send to {0_opponent}: {1_yieldList}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_TRADE_FROM",
        "English": "Trade from {0_opponent}: {1_yieldList} for {2_years} {3_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_TRADE_TO",
        "English": "Trade to {0_opponent}: {1_yieldList} for {2_years} {3_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_TRIBUTE_FROM",
        "English": "Tribute from {0_opponent}: {1_yieldList} for {2_years} {3_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_TRIBUTE_TO",
        "English": "Tribute to {0_opponent}: {1_yieldList} for {2_years} {3_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_CHANGE_DIPLOMACY",
      ...
      },
      {
        ...
        "English": "Joins the link(CONCEPT_NATION) of {0_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_SEIZE_THRONE",
        "English": "Seizes the Throne of {0_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_RELEASE_GENERAL",
        "English": "Leave {0_unit}"
      },
      {
      ...
      },
      {
        ...
        "English": "Leave Governorship of {0_city}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_RELEASE_GOVERNOR_GENERIC",
        "English": "Leave Governorship"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_RELEASE_AGENT",
        "English": "Leave role of link(CONCEPT_AGENT) in {0_city}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_RELEASE_AGENT_GENERIC",
        "English": "Leave role of link(CONCEPT_AGENT)"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_CHANGE_SUCCESSION_GENERIC",
        "English": "Rework Succession to become Heir"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_ABDICATE_THRONE",
        "English": "Abdicate the Throne (New Leader: {true_0:{0_leader}:None})"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_WILL_DIE",
        "English": "Will Soon Die"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_CONVERT_UNIT",
        "English": "{0_unit} Converts to {1_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_SET_VEGETATION",
        "English": "Set {0_vegetation} on {1_tile}{true_2: near {2_city}}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_SET_RESOURCE",
        "English": "Set {0_resource} on {1_tile}{true_2: near {2_city}}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_SET_IMPROVEMENT",
        "English": "Set {0_improvement} on {1_tile}{true_2: near {2_city}}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_SET_SPECIALIST",
        "English": "Set {0_specialist} on {1_tile}{true_2: near {2_city}}"
      },
      {
      ...
      },
      {
        ...
        "English": "Gain link(CONCEPT_MERCENARY) {0_unit}{true_1: (x{1_number})}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_TRIBE_UNIT",
        "English": "New {0,1_tribe} {1_unit}{true_2: (x{2_number})} on {3_tile}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_TRADE_CITY",
        "English": "{0_link} gains {1_city}"
      },
      {
      ...
      },
      {
        ...
        "English": "Free link(CONCEPT_THEOLOGY){true_0: ({0_religion})}: {1_theology}"
      },
      {
      ...
      },
      {
        ...
        "English": "Found a Religion"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_STATE_RELIGION_END",
        "English": "End link(CONCEPT_STATE_RELIGION){true_0: ({0_religion})}"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_RANODM_TECH",
        "English": "Acquire Random Technology"
      },
      {
        "zType": "TEXT_HELPTEXT_BONUS_ACQUIRE_TECH",
        "English": "Acquire {LIST} (Technology)"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} {true_1:increases:decreases} Foreign link(CONCEPT_OPINION_PLAYER,3)"
      },
      {
        "zType": "TEXT_HELPTEXT_MAKE_COUNCIL_TRIBE_OPINION_CHANGE",
        "English": "{0} {true_1:increases:decreases} link(CONCEPT_OPINION_TRIBE,1)"
      },
      {
        "zType": "TEXT_HELPTEXT_MAKE_COUNCIL_RELIGION_OPINION_CHANGE",
        "English": "{0} {true_1:increases:decreases} link(CONCEPT_OPINION_RELIGION,1)"
      },
      {
        "zType": "TEXT_HELPTEXT_MAKE_COUNCIL_FAMILY_OPINION_CHANGE",
        "English": "{0} {true_1:increases:decreases} link(CONCEPT_OPINION_FAMILY,1)"
      },
      {
        "zType": "TEXT_HELPTEXT_MAKE_COUNCIL_YIELD_CHANGE",
        "English": "{0} {true_1:increases:decreases} {2_yield}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} {true_1:increases:decreases} {2_yield} per City"
      },
      {
      ...
      },
      {
        ...
        "English": "Replacing {0} will add link(TRAIT_SLIGHTED)"
      },
      {
      ...
      },
      {
        ...
        "English": "Each Courtier: {0} per {1_turnScale}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} link(YIELD_CULTURE): {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_CULTURE_HELP",
        "English": "{0}{1} {true_2:(Requires {2} link(YIELD_CULTURE))}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_percent} from {1_rating}"
      },
      {
        "zType": "TEXT_HELPTEXT_MISSION_PER_RATING_LEVEL",
        "English": "{0_percent} per {1_rating}"
      },
      {
        "zType": "TEXT_HELPTEXT_MISSION_COUNCIL_ALREADY",
        "English": "Is already the {0_council}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_character}: {1_value} XP"
      },
      {
        "zType": "TEXT_HELPTEXT_MISSION_XP",
        "English": "Character: {0_value} XP"
      },
      {
        "zType": "TEXT_HELPTEXT_MISSION_ALREADY_ACTIVE",
        "English": "A Mission is already active: {0}{true_2: ({2_link})}, {1_turns}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_TRAIT_GENERAL",
        "English": "link(CONCEPT_GENERAL): {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_GENERAL_LEADER",
      ...
      },
      {
        ...
        "English": "Cannot Marry"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_NO_BIRTH",
        "English": "Cannot have Children"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_NO_HEIR",
        "English": "Excluded from the Succession"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_NO_JOB",
        "English": "Cannot be a link(CONCEPT_GOVERNOR), link(CONCEPT_GENERAL), or on the Council"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_NO_COURTIER",
        "English": "Cannot be a {0_courtier}"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_NO_FAMILY_HEAD",
        "English": "Cannot be a link(CONCEPT_FAMILY) Head"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_NO_RELIGION_HEAD",
        "English": "Cannot be a link(CONCEPT_RELIGION) Head"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_NO_RELIGION",
        "English": "Cannot have a link(CONCEPT_RELIGION)"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_NO_EVENTS",
        "English": "Can only be part of {0_trait} Events"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_JOB_ANY_FAMILY",
        "English": "{0_job} (for any link(CONCEPT_FAMILY))"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_JOB_PREREQ",
        "English": "Can serve as {0_list}"
      },
      {
      ...
      },
      {
        ...
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if not of same link(CONCEPT_STATE_RELIGION)"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_PROXIMITY",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if too close to us"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_STRENGTH",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if stronger than us"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_KNOWLEDGE",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if more knowledgeable than us"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_GENERALS",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if more link(CONCEPT_GENERAL,2) than us"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_GOVERNORS",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if more link(CONCEPT_GOVERNOR,2) than us"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_WONDERS",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if more Wonders than us"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_LAWS",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if more Active Laws than us"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_COGNOMEN",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if Leader has better Cognomen than our Leader"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_OPINION_TRADES",
        "English": "As Leader: {0_value} link(CONCEPT_OPINION_CHARACTER,3) if more Trades with another Nation than with us"
      },
      {
      ...
      },
      {
        ...
        "English": "Included in: {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_TRAIT_EXCUDED_FROM",
        "English": "Excluded from: {LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_name} ({1_team})"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_DIFFICULTY",
        "English": "Difficulty: {0_difficulty}"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_NATION",
        "English": "Nation: {0_difficulty}"
      },
      {
      ...
      },
      {
        ...
        "English": "link(DIPLOMACY_WAR) State: {0} ({1})"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_TRADE_FOR_US",
        "English": "{0_trade} from: {YIELD-LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_TRADE_FOR_THEM",
        "English": "{0_trade} to: {YIELD-LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_TRIBUTE_FROM",
        "English": "{0_tribute} from: {YIELD-LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_TRIBUTE_TO",
        "English": "{0_tribute} to: {YIELD-LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_opinion}: Similar Ruling Family ({1_familyClass})"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_OPINION_NATION",
        "English": "{0_opinion}: Ancient Antipathy vs {1_nation}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_opinion}: You are very close to winning"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_OPINION_PLAY_TO_WIN_CLOSE",
        "English": "{0_opinion}: You are close to winning"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_OPINION_PLAY_TO_WIN_NEAR",
        "English": "{0_opinion}: You could end up winning"
      },
      {
        "zType": "TEXT_HELPTEXT_PLAYER_OPINION_PLAY_TO_WIN",
        "English": "{0_opinion}: You are starting to win"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_LUXURIES",
        "English": "{0_opinion}: Our link(CONCEPT_LUXURY)"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} (Religion){true_1:, Founded in Year {1}}"
      },
      {
        "zType": "TEXT_HELPTEXT_RELIGION_THEOLOGIES",
        "English": "{singular_0:Theology:Theologies}:"
      },
      {
        "zType": "TEXT_HELPTEXT_RELIGION_HEAD",
        "English": "Head: {0_character}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0}% Chance/{1_turnScale} of Spreading to new Cities"
      },
      {
        "zType": "TEXT_HELPTEXT_RELIGION_PREREQ_RELIGION_CITY",
        "English": "Requires {0,1_religion} City"
      },
      {
        "zType": "TEXT_HELPTEXT_RELIGION_PREREQ_NUM_RELIGION_CITIES",
        "English": "Requires {0_num} Global {1_religion} {singular_1:City:Cities}"
      },
      {
      ...
      },
      {
        ...
        "English": "{true_0:Adopted:Adopt} {1} as link(CONCEPT_STATE_RELIGION):"
      },
      {
        "zType": "TEXT_HELPTEXT_STATE_RELIGION_CAN_BUILD_UNITS",
        "English": "Can Build {UNIT-LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value}: Traits{true_LIST-COUNT: ({LIST})}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_FROM_OUR",
        "English": "{0_value}: From Our {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_FROM_THEIR",
        "English": "{0_value}: From Their {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_CITIES_CLOSE",
        "English": "{0_value}: Our cities are close together"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_CITIES_DISTANT",
        "English": "{0_value}: Our cities are far apart"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_LEADER",
        "English": "{0_value}: Leader from Our Family"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_HEIR",
        "English": "{0_value}: Heir from Our Family"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_LEADER_SPOUSE",
        "English": "{0_value}: Leader's Spouse from Our Family"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_HEIR_SPOUSE",
        "English": "{0_value}: Heir's Spouse from Our Family"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_DESCENDANT_SPOUSE",
        "English": "{0_value}: Marriage(s) to Leader's Descendants"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_CHILD_LEADER",
        "English": "{0_value}: Leader not an Adult"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_UMARRIED_LEADER",
        "English": "{0_value}: Unmarried Leader"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_LEADER_MARRIED_FOREIGN",
        "English": "{0_value}: Leader Married Foreign Spouse"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_LEADER_MARRIED_TRIBE",
        "English": "{0_value}: Leader Married link(CONCEPT_TRIBE,3) Spouse"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_value}: Our link(CONCEPT_LUXURY){true_LIST-COUNT: ({LIST})}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_MISSING_LUXURIES",
        "English": "{0_value}: Missing link(CONCEPT_LUXURY){true_LIST-COUNT: ({LIST})}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_OUR_WONDERS",
        "English": "{0_value}: Wonders in Our Territory"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_OUR_HOLY_CITIES",
        "English": "{0_value}: Holy Cities in Our Territory"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_EFFECT_CITY",
        "English": "{0_value}: Per {1_effect}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_MOST_CITIES",
        "English": "{0_value}: Most Cities"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_FEWEST_CITIES",
        "English": "{0_value}: Fewest Cities"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_CITIES_NO_RELIGION",
        "English": "{0_value}: Cities without Religion"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_CITIES_CONNECTED",
        "English": "{0_value}: Connected Cities"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_CITIES_DAMAGED",
        "English": "{0_value}: Our Damaged Cities"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_CITIES_DEFENDING",
        "English": "{0_value}: Our Cities with Defending Units"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_PILLAGED",
        "English": "{0_value}: Pillaged Improvements inside Our Territory"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_HOSTILE_UNITS_IN_TERRITORY",
        "English": "{0_value}: Hostile Units are inside Our Territory"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_EACH_CITY_EFFECT",
        "English": "Each {true_0:{0}:Family} City: {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_FAMILY_EACH_UNIT_EFFECT",
        "English": "Each {true_0:{0}:Family} Unit: {1}"
      },
      {
      ...
      },
      {
        ...
        "English": "Harvest {0_resource}{true_1: (Auto)}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_TILE_ADD_ROAD_TO_BUTTON",
        "English": "Connect To Tile"
      },
      {
        "zType": "TEXT_HELPTEXT_WIDGET_ROAD_TO",
        "English": "Connects current Tile to the selected Tile's network using the shortest path"
      },
      {
        "zType": "TEXT_HELPTEXT_TILE_ADD_URBAN_BUTTON",
        "English": "Add link(CONCEPT_URBAN)"
      },
      {
      ...
      },
      {
        ...
        "English": "Cancel {0_improvement}"
      },
      {
        "zType": "TEXT_HELPTEXT_TILE_CANCEL_UNIT_QUEUE_BUTTON",
        "English": "Cancel Action Queue"
      },
      {
        "zType": "TEXT_HELPTEXT_TILE_FOUND_CAPITAL_BUTTON",
        "English": "Found Capital"
      },
      {
        "zType": "TEXT_HELPTEXT_TILE_FOUND_FAMILY_CAPITAL_BUTTON",
        "English": "Found {0_capital}<br>{1_familyName} {2_familyClass}"
      },
      {
        "zType": "TEXT_HELPTEXT_TILE_FOUND_FAMILY_SEAT_BUTTON",
        "English": "Found link(CONCEPT_FAMILY_SEAT)<br>{0_familyName} {1_familyClass}"
      },
      {
        "zType": "TEXT_HELPTEXT_TILE_FOUND_FAMILY_CITY_BUTTON",
        "English": "Found City<br>{0_familyName} {1_familyClass}"
      },
      {
      ...
      },
      {
        ...
        "English": "Establish {0,1_religionAdj} {1_theology}"
      },
      {
        "zType": "TEXT_HELPTEXT_TILE_ESTABLISH_THEOLOGY_BUTTON",
        "English": "Establish link(CONCEPT_THEOLOGY)"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_RELIGION_POPUP_ADOPT",
        "English": "Adopt {0_religion}"
      },
      {
        "zType": "TEXT_HELPTEXT_RELIGION_ADOPT_REQUIREMENT",
        "English": "Requires any City with {0_religion}"
      },
      {
        "zType": "TEXT_HELPTEXT_RELIGION_REQUIREMENTS_HEADER",
        "English": "Requires"
      },
      {
        "zType": "TEXT_HELPTEXT_RELIGION_STATE_HEADER",
        "English": "As link(CONCEPT_STATE_RELIGION)"
      },
      {
        "zType": "TEXT_HELPTEXT_RESOURCE_NAME",
        "English": "{0_resource}{true_1: (* Harvested)}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0_project} {true_1:(Repeatable):(Permanent)}"
      },
      {
        "zType": "TEXT_HELPTEXT_PROJECT_ON_COMPLETION",
        "English": "On Completion: {0}"
      },
      {
      ...
      },
      {
        ...
        "English": "Minimum link(YIELD_CULTURE): {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_PROJECT_REQUIRES_CULTURE",
        "English": "Requires link(YIELD_CULTURE): {0}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_SPECIALIST_FROM_RESOURCE",
        "English": "From {0_resource}: {1}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_TAB_PANEL_CHARACTERS_SPOUSES",
        "English": "Spouse(s):"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} (Tier {1} link(CONCEPT_THEOLOGY))"
      },
      {
      ...
      },
      {
        ...
        "English": "Establish with {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_THEOLOGY_HELP_ONE_PER_TIER",
        "English": "Max One Tier {0} link(CONCEPT_THEOLOGY) per Religion"
      },
      {
        "zType": "TEXT_HELPTEXT_THEOLOGY_HELP_REQUIRES_STATE_RELIGION",
        "English": "Must be link(CONCEPT_STATE_RELIGION) to Establish"
      },
      {
      ...
      },
      {
        ...
        "English": "(Unit already has this Promotion)"
      },
      {
      ...
      },
      {
        ...
        "English": "Cognomen: {0} ({1_legitimacy}: {2})"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_EFFECT_IF_LEADER",
        "English": "If Leader, {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_HELP_NAME",
        "English": "{0_gender}, Age {1}{true_2:, {2}/{3} XP}"
      },
      {
      ...
      },
      {
        ...
        "English": "Mission: {0}{true_2: ({2_link})}, {1_turns}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0}: You do not follow {1_religion}, the link(CONCEPT_STATE_RELIGION) of {2_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_OPINION_TRAIT_PROXIMITY",
        "English": "{0}: Too close to {1_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_OPINION_TRAIT_STRENGTH",
        "English": "{0}: Stronger than {1_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_OPINION_TRAIT_KNOWLEDGE",
        "English": "{0}: More knowledgeable than {1_player}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_OPINION_TRAIT_GENERALS",
        "English": "{0}: More link(CONCEPT_GENERAL,2), {1}, than {3_player}, {2}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_OPINION_TRAIT_GOVERNORS",
        "English": "{0}: More link(CONCEPT_GOVERNOR,2), {1}, than {3_player}, {2}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_OPINION_TRAIT_WONDERS",
        "English": "{0}: More Wonders, {1}, than {3_player}, {2}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_OPINION_TRAIT_LAWS",
        "English": "{0}: More Active Laws, {1}, than {3_player}, {2}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_OPINION_TRAIT_COGNOMEN",
        "English": "{0}: Your Cognomen ({1_cognomen}) is greater than mine ({2_cognomen})"
      },
      {
      ...
      },
      {
        ...
        "English": "As link(CONCEPT_GENERAL) (if Leader): {0}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0} will join Nation of {1}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHARACTER_MARRIES_DOWRY_COST",
        "English": "Dowry will give us {LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "Will leave Council as {0_council}"
      },
      {
        "zType": "TEXT_HELPTEXT_LEAVE_JOB_GENERAL",
        "English": "Will no longer lead the {0_unit}"
      },
      {
        "zType": "TEXT_HELPTEXT_LEAVE_JOB_GOVERNOR",
        "English": "Will no longer govern {0_city}"
      },
      {
      ...
      },
      {
        ...
        "English": "Current link(CONCEPT_GOVERNOR): {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_HOTKEY_SELECT_GOVERNOR",
        "English": "<TEXT_HOTKEY_CTRL_CLICK> to Select the link(CONCEPT_GOVERNOR)"
      },
      {
        "zType": "TEXT_HELPTEXT_MAKE_GOVERNOR",
        "English": "{true_0:Keep:Make} {1} link(CONCEPT_GOVERNOR) of {2}"
      },
      {
        "zType": "TEXT_HELPTEXT_MAKE_GOVERNOR_ALREADY",
        "English": "Is Already link(CONCEPT_GOVERNOR)"
      },
      {
      ...
      },
      {
        ...
        "English": "{true_0:Keep:Make} {1} link(CONCEPT_AGENT) in {2}"
      },
      {
      ...
      },
      {
        ...
        "English": "Choose link(CONCEPT_AGENT) for {0_city}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHOOSE_AGENT_CURRENT_AGENT",
        "English": "Current link(CONCEPT_AGENT): {0_character}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHOOSE_AGENT_CLICK_TO_CHANGE_AGENT",
        "English": "<TEXT_HOTKEY_CTRL_CLICK> to Change the link(CONCEPT_AGENT)"
      },
      {
        "zType": "TEXT_HELPTEXT_AGENT_WILL_RETURN",
        "English": "Will Return {0_unit} in {1_number} {singular_1:Year:Years}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHOOSE_GENERAL_POPUP_TITLE",
        "English": "Choose link(CONCEPT_GENERAL) for {0_unit}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHOOSE_GOVERNOR_POPUP_TITLE",
        "English": "Choose a link(CONCEPT_GOVERNOR) for {0_city}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHOOSE_AGENT_POPUP_TITLE",
        "English": "Place an link(CONCEPT_AGENT) in {0_city}"
      },
      {
        "zType": "TEXT_HELPTEXT_CHOOSE_COUNCIL_POPUP_TITLE",
        "English": "Choose your {0_council}"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_SAVE_TO_CLOUD",
      ...
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_LOAD_FROM_CLOUD",
        "English": "Load from Cloud"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_NOTIFICATION_EMAIL",
        "English": "Turn Notifications"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_DEBUG_REPLAY_FIVE_TURNS_BUTTON",
        "English": "Replay last five turns"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_DEBUG_REPLAY_GAME_BUTTON",
        "English": "Replay entire game"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_DEBUG_DISABLE_REPLAY_BUTTON",
        "English": "Disable full replay"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_DEBUG_ENABLE_REPLAY_BUTTON",
        "English": "Enable full replay"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_DEBUG_AUTO_NEXT_TURN_BUTTON",
        "English": "Auto-play next turn"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_DEBUG_AUTO_TEN_TURNS_BUTTON",
        "English": "Auto-play 10 turns"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_CHANGE_PLAYER_INFO_BUTTON",
        "English": "Change Player information"
      },
      {
      ...
      {
        "zType": "TEXT_HELPTEXT_POPUP_MAIN_MENU_HELP_BUTTON",
        "English": "Help"
      },
      {
      ...
      },
      {
        ...
        "English": "Visit the Old World developer blog"
      },
      {
        "zType": "TEXT_HELPTEXT_MAIN_MENU_MANUAL",
        "English": "Open the player manual for Old World (Opens in browser)"
      },
      {
        "zType": "TEXT_HELPTEXT_MAIN_MENU_DISCORD",
        "English": "Visit the Discord channel for Old World"
      },
      {
        "zType": "TEXT_HELPTEXT_MAIN_MENU_REDDIT",
        "English": "Visit the Old World sub on Reddit"
      },
      {
        "zType": "TEXT_HELPTEXT_MAIN_MENU_TWITCH",
        "English": "Visit the Twitch channel for Mohawk Games"
      },
      {
        "zType": "TEXT_HELPTEXT_MAIN_MENU_TWITTER",
        "English": "Visit the Twitter account for Mohawk Games"
      },
      {
        "zType": "TEXT_HELPTEXT_MAIN_MENU_CIV_FANATICS",
        "English": "Visit the Old World forum on Civ Fanatics"
      },
      {
        "zType": "TEXT_HELPTEXT_JOIN_MP_NEED_PASSWORD",
        "English": "You must enter a password to join the game"
      },
      {
        "zType": "TEXT_HELPTEXT_DELETE_CLOUD_SAVE",
        "English": "Remove this game from your list of active games. If you are the game's host, this deletes the game for all other players as well."
      },
      {
        "zType": "TEXT_HELPTEXT_DOWNLOAD_CLOUD_SAVE",
        "English": "Download the game save file from the cloud (host only)."
      },
      {
      ...
      },
      {
        ...
        "English": "Rules for player nation selection"
      },
      {
        "zType": "TEXT_HELPTEXT_OPTION_TEAM_NATIONS_CHARACTERS_WARNING",
        "English": "Nations must be Unique when Characters with non-random leaders are enabled"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DISBAND_UNIT_PROMPT_TITLE",
        "English": "Disband {0_unit}?"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_CANCEL_BUILD_PROMPT_TITLE",
        "English": "Lose {0_build} progress?"
      },
      {
      ...
      },
      {
        ...
        "English": "Abandon {0_ambition} ambition?"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECLARE_WAR_TRIBE_TURNS",
        "English": "Cannot Declare link(DIPLOMACY_WAR) on the {0_barbarians} for {1_value} more {2_turnScale}."
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECLARE_WAR_TEAM_TURNS",
        "English": "Cannot Declare link(DIPLOMACY_WAR) on {0_team} for {1_value} more {2_turnScale}."
      },
      {
      ...
      },
      {
        ...
        "English": "Missing Tech"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_INHERITANCE_LABEL",
        "English": "{0_law}<br>({true_1:{1}:No Heir})"
      },
      {
      ...
      },
      {
        ...
        "English": "Custom Map Options"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_FAMILY_TREE_ROAL_LINE",
        "English": "link(CONCEPT_ROYAL) Line"
      },
      {
      ...
      },
      {
        ...
        "English": "{singular_0:Nation:Nations}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_TRIBES",
        "English": "{singular_0:Tribe:Tribes}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_UNIQUE_UNITS",
        "English": "Unique {singular_0:Unit:Units}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_UNLOCKS_UNITS",
        "English": "Unlocks {singular_0:Unit:Units}"
      },
      {
      ...
      },
      {
        ...
        "English": "{singular_0:Unit:Units}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_REQUIRES_BUILDINGS",
        "English": "Requires {singular_0:Improvement:Improvements}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_UNIQUE_BUILDINGS",
        "English": "Unique {singular_0:Improvement:Improvements}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_UNLOCKS_BUILDINGS",
        "English": "Unlocks {singular_0:Improvement:Improvements}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_BUILDINGS",
        "English": "{singular_0:Improvement:Improvements}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_UNLOCKS_SPECIALISTS",
        "English": "Unlocks {singular_0:Specialist:Specialists}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_SPECIALISTS",
        "English": "{singular_0:Specialist:Specialists}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_STARTING_LAWS",
        "English": "Starting {singular_0:Law:Laws}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_UNLOCKS_LAWS",
        "English": "Unlocks {singular_0:Law:Laws}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_LAWS",
        "English": "{singular_0:Law:Laws}"
      },
      {
      ...
      },
      {
        ...
        "English": "Required {singular_0:Religion:Religions}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_RELIGIONS",
        "English": "{singular_0:Religion:Religions}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_LEADERS",
        "English": "{singular_0:Leader:Leaders}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_CHARACTERS",
        "English": "{singular_0:Character:Characters}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_FAMILIES",
        "English": "{singular_0:Family:Families}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_REQUIRED_TECHS",
        "English": "Required {singular_0:Tech:Techs}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_STARTING_TECHS",
        "English": "Starting {singular_0:Tech:Techs}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_UNLOCKS_TECHS",
        "English": "Unlocks {singular_0:Tech:Techs}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_UNLOCKS_COUNCILS",
        "English": "Unlocks {singular_0:Council:Councils}"
      },
      {
        "zType": "TEXT_HELPTEXT_HELPSCREEN_TERRAINS",
        "English": "{singular_0:Terrain:Terrains}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPTIONS_LANGUAGE_MOD_DROPDOWN_ITEM",
        "English": "{0_language} (User Translation)"
      },
      {
        "zType": "TEXT_HELPTEXT_OPTIONS_LOCKED_OPTION",
        "English": "Cannot be toggled because \"Lock Player Options\" settings was enabled at game creation"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECISION_NOT_VALID_DESC",
        "English": "Decision no longer valid. [{0_event}]"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECISION_CHOOSE_AMBITION_HELP",
        "English": "It's time to choose your next link(CONCEPT_AMBITION)..."
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECISION_CITY_FAMILY_TITLE",
        "English": "Assign Family"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECISION_CITY_FAMILY_DESC",
        "English": "Give your newest City, {0_city}, to one of your Families..."
      },
      {
      ...
      },
      {
        ...
        "English": "Accept {0_peace} with the {1_barbarians} for {2_money}?"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECISION_OFFER_TRUCE_TRIBE_DESC",
        "English": "Accept a {0_truce} with the {1_barbarians} for {2_money}?"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECISION_OFFER_PEACE_PLAYER_DESC",
        "English": "Accept {0_peace} with {1_player} for {2_money}?"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECISION_OFFER_TRUCE_PLAYER_DESC",
        "English": "Accept a {0_truce} with {1_player} for {2_money}?"
      },
      {
      ...
      },
      {
        ...
        "English": "Choose {0_city} Family:"
      },
      {
        "zType": "TEXT_HELPTEXT_POPUP_DECISION_DIPLOMACY_TITLE",
        "English": "Make {0_diplomacy} with {1} for {2_money}?"
      },
      {
      ...
      },
      {
        ...
        "English": "End the {1_turnScale}{true_0: {0}}"
      },
      {
        "zType": "TEXT_HELPTEXT_END_YEAR_IDLE_CITY",
        "English": "You need to manage an link(CONCEPT_IDLE) City first..."
      },
      {
        "zType": "TEXT_HELPTEXT_END_YEAR_DECISION",
        "English": "You have an important Decision to make first..."
      },
      {
        "zType": "TEXT_HELPTEXT_END_YEAR_RESEARCH",
        "English": "You have to choose a new technology to research first..."
      },
      {
        "zType": "TEXT_HELPTEXT_END_YEAR_WAITING",
        "English": "Waiting for {PLAYER-LIST}"
      },
      {
      ...
      },
      {
        ...
        "English": "Start {0} Law{true_1: (Replaces {1})}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_THEOLOGY",
        "English": "Establish {0} link(CONCEPT_THEOLOGY) for a link(CONCEPT_WORLD_RELIGION)"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_DIPLOMACY_ALL",
        "English": "Requires {0_diplomacy} with All link(CONCEPT_TRIBE,2) and link(CONCEPT_NATION,2)"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_MIN_OPINION_FAMILY",
        "English": "Requires at least {0_opinion} with All link(CONCEPT_FAMILY,2)"
      },
      {
      ...
      },
      {
        ...
        "English": "Requires {0} {singular_0:City:Cities}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_CONNECTED_CITIES",
        "English": "Requires {0} {1_connectedLink} {singular_0:City:Cities}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_CITIZENS",
        "English": "Requires {0} {singular_0:{1_citizenLink}:{1,2_citizensLink}}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_SPECIALISTS",
        "English": "Requires {0} {singular_0:Specialist:Specialists}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_POPULATION",
        "English": "Requires {0} Population ({1,2_citizensLink} + Specialists)"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_LUXURIES",
        "English": "Requires {0} {singular_0:{1_luxuryLink}:{1,2_luxuriesLink}}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_PLAYER_LUXURIES",
        "English": "Requires {0} {singular_0:{1_luxuryLink}:{1,2_luxuriesLink}} sent to Foreign Nations"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_TRIBE_LUXURIES",
        "English": "Requires {0} {singular_0:{1_luxuryLink}:{1,2_luxuriesLink}} sent to Tribes"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_FAMILY_LUXURIES",
        "English": "Requires {0} {singular_0:{1_luxuryLink}:{1,2_luxuriesLink}} sent to Families"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_URBAN_TILES",
        "English": "Requires {0} link(TERRAIN_URBAN) {singular_0:Tile:Tiles}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_URBAN_IMPROVEMENTS",
        "English": "Requires {0} link(CONCEPT_URBAN) {singular_0:Improvement:Improvements}"
      },
      {
      ...
      },
      {
        ...
        "English": "Reveal {0} of the Land"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_MILITARY_UNITS",
        "English": "Requires {0} Military {singular_0:Unit:Units}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_MAX_LEVEL_UNITS",
        "English": "Requires {0} Max Level {singular_0:Unit:Units}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_GENERALS",
        "English": "Requires {0} {singular_0:link(CONCEPT_GENERAL):link(CONCEPT_GENERAL,2)}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_GOVERNORS",
        "English": "Requires {0} {singular_0:link(CONCEPT_GOVERNOR):link(CONCEPT_GOVERNOR,2)}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_AGENTS",
        "English": "Requires {0} Character {singular_0:link(CONCEPT_AGENT):link(CONCEPT_AGENT,2)}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_TOTAL",
        "English": "Requires {0} Total {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_CAPTURE_PLAYER_CITIES",
        "English": "Capture {0} {true_1:{1,1}:Foreign} {singular_0:City:Cities}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_CAPTURE_TRIBE_SITES",
        "English": "Capture {0} {true_1:{1,1}:Tribal} {singular_0:Site:Sites}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_SETTLE_TRIBE_SITES",
        "English": "Found Cities on {0} {true_1:{1,1}:Tribal} {singular_0:Site:Sites}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_KILL_PLAYER_ENEMY_UNITS",
        "English": "Kill {0} {true_1:{1,1}:Foreign} Military {singular_0:Unit:Units}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_KILL_TRIBE_ENEMY_UNITS",
        "English": "Kill {0} {true_1:{1,1}:Tribal} Military {singular_0:Unit:Units}"
      },
      {
      ...
      },
      {
        ...
        "English": "Eliminate {true_0:the {0}:a Tribe}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_DIPLOMACY_WITH",
        "English": "Requires {0_diplomacy} with {1} {singular_1:Tribe or Nation:Tribes or Nations}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_KILL_TRIBE_UNITS",
        "English": "Kill {0} {1_tribe} {singular_0:Unit:Units}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_PRODUCE_YIELD_PER_YEAR",
        "English": "Produce {0} {1_yield}/{2_turnScale}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_PRODUCE_YIELD_MASS",
        "English": "Produce {0} {1_yield}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_RESOURCE_REVEALED",
        "English": "Discover {0} {1_resource}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_X",
        "English": "Requires {0_num} {singular_0:{1}:{1,2}}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_PLAYER_LUXURY",
        "English": "Requires {0} {1_resource} {singular_0:{2_luxuryLink}:{2,2_luxuriesLink} sent to Foreign Nations}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_TRIBE_LUXURY",
        "English": "Requires {0} {1_resource} {singular_0:{2_luxuryLink}:{2,2_luxuriesLink} sent to Tribes}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_FAMILY_LUXURY",
        "English": "Requires {0} {1_resource} {singular_0:{2_luxuryLink}:{2,2_luxuriesLink} sent to Families}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_REQUIRES_CITIES_CULTURE",
        "English": "Requires {0_num} {singular_0:City:Cities} with {1_cultureLevel} link(YIELD_CULTURE)"
      },
      {
      ...
      },
      {
        ...
        "English": "{1_turnScale} Left: {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_GOAL_HELP_MAX_YEARS",
        "English": "Max {1_turnScale}: {0}"
      },
      {
      ...
      },
      {
        ...
        "English": "{true_0:{0} (Law)}{true_1: [Current]}"
      },
      {
      ...
      },
      {
        ...
        "English": "Cannot change Succession Laws when the Leader is Dead"
      },
      {
      ...
      },
      {
        ...
        "English": "Families: {LIST}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_COUNCIL_ETHNICITY",
        "English": "{0_opinion}: Council Member(s) are {1,1_ethnicity}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_OUR_ALLY",
        "English": "{0_opinion}: In an link(CONCEPT_ALLIANCE_PLAYER)"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_NOT_OUR_ALLY",
        "English": "{0_opinion}: In link(CONCEPT_ALLIANCE_PLAYER) with {1_team}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_LEADER",
        "English": "{0_opinion}: Leader is {1,1_ethnicity}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_LEADER_SPOUSE",
        "English": "{0_opinion}: Leader's Spouse is {1,1_ethnicity}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_HEIR",
        "English": "{0_opinion}: Heir is {1,1_ethnicity}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_HEIR_SPOUSE",
        "English": "{0_opinion}: Heir's Spouse is {1,1_ethnicity}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPINION_DESCENDANTS",
        "English": "{0_opinion}: Leader's Descendant(s) are {1,1_ethnicity}"
      },
      {
      ...
      },
      {
        ...
        "English": "{0}: {1,1_religion} Improvements"
      },
      {
      ...
      },
      {
        ...
        "English": "Will not declare link(DIPLOMACY_WAR) before Turn {0}"
      },
      {
        "zType": "TEXT_HELPTEXT_OPPONENT_LEVEL_END_WAR_MIN_TURNS",
        "English": "Will not make link(DIPLOMACY_TRUCE) for {0} {singular_0:Turn:Turns}"
      },
      {
